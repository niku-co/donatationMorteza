...
namespace Data.Migrations
{
    ...
    [Migration("20230504034810_IntentionCode-Item")]
    partial class IntentionCodeItem
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Entities.Cart", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        ...
                        .HasDefaultValue(new DateTime(2023, 5, 4, 7, 18, 9, 981, DateTimeKind.Local).AddTicks(8949));
            ...
            modelBuilder.Entity("Entities.Category", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 5, 4, 7, 18, 9, 982, DateTimeKind.Local).AddTicks(73));
            ...
            modelBuilder.Entity("Entities.Item", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 5, 4, 7, 18, 9, 982, DateTimeKind.Local).AddTicks(1072));
            ...
            modelBuilder.Entity("Entities.ItemImage", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 5, 4, 7, 18, 9, 982, DateTimeKind.Local).AddTicks(1797));
            ...
            modelBuilder.Entity("Entities.User.User", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 5, 4, 7, 18, 9, 982, DateTimeKind.Local).AddTicks(2723));
