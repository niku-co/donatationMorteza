...
namespace Data.Migrations
{
    ...
    [Migration("20211019075136_make-optional-CartItems")]
    partial class makeoptionalCartItems
    {
            ...
            modelBuilder.Entity("Entities.Cart", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        ...
                        .HasDefaultValue(new DateTime(2021, 10, 19, 11, 21, 35, 958, DateTimeKind.Local).AddTicks(1259));
            ...
            modelBuilder.Entity("Entities.Category", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 10, 19, 11, 21, 35, 958, DateTimeKind.Local).AddTicks(6168));
            ...
            modelBuilder.Entity("Entities.Item", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 10, 19, 11, 21, 35, 958, DateTimeKind.Local).AddTicks(8204));
            ...
            modelBuilder.Entity("Entities.ItemImage", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 10, 19, 11, 21, 35, 959, DateTimeKind.Local).AddTicks(41));
