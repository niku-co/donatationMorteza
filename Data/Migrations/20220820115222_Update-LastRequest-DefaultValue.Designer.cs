...
namespace Data.Migrations
{
    ...
    [Migration("20220820115222_Update-LastRequest-DefaultValue")]
    partial class UpdateLastRequestDefaultValue
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Entities.Cart", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        ...
                        .HasDefaultValue(new DateTime(2022, 8, 20, 16, 22, 22, 324, DateTimeKind.Local).AddTicks(3501));
            ...
            modelBuilder.Entity("Entities.Category", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 8, 20, 16, 22, 22, 324, DateTimeKind.Local).AddTicks(5609));
                    ...
                    b.Property<DateTime>("LastRequest")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 8, 20, 16, 22, 22, 323, DateTimeKind.Local).AddTicks(393));
            ...
            modelBuilder.Entity("Entities.Item", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 8, 20, 16, 22, 22, 324, DateTimeKind.Local).AddTicks(7760));
            ...
            modelBuilder.Entity("Entities.Item_Translation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Entities.ItemImage", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 8, 20, 16, 22, 22, 324, DateTimeKind.Local).AddTicks(9649));
            ...
            modelBuilder.Entity("Entities.Language", b =>
                {
                    b.Navigation("Item_Translations");
                });
