...
namespace Data.Migrations
{
    ...
    [Migration("20230510075039_Add-Setting-HighlightColorHexCode-BackgroundPhysicalPath-SwipeCardPhysicalPath")]
    partial class AddSettingHighlightColorHexCodeBackgroundPhysicalPathSwipeCardPhysicalPath
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Entities.Cart", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        ...
                        .HasDefaultValue(new DateTime(2023, 5, 10, 11, 20, 39, 263, DateTimeKind.Local).AddTicks(1174));
            ...
            modelBuilder.Entity("Entities.Category", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 5, 10, 11, 20, 39, 263, DateTimeKind.Local).AddTicks(2975));
            ...
            modelBuilder.Entity("Entities.Item", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 5, 10, 11, 20, 39, 263, DateTimeKind.Local).AddTicks(4010));
            ...
            modelBuilder.Entity("Entities.ItemImage", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 5, 10, 11, 20, 39, 263, DateTimeKind.Local).AddTicks(5396));
            ...
            modelBuilder.Entity("Entities.User.User", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 5, 10, 11, 20, 39, 263, DateTimeKind.Local).AddTicks(6114));
