...
namespace Data.Migrations
{
    ...
    [Migration("20220829113602_AddCodeNameToLanguage")]
    partial class AddCodeNameToLanguage
    {
            ...
            modelBuilder.Entity("Entities.Cart", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        ...
                        .HasDefaultValue(new DateTime(2022, 8, 29, 16, 6, 2, 456, DateTimeKind.Local).AddTicks(5122));
            ...
            modelBuilder.Entity("Entities.Category", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 8, 29, 16, 6, 2, 456, DateTimeKind.Local).AddTicks(7420));
            ...
            modelBuilder.Entity("Entities.Item", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 8, 29, 16, 6, 2, 456, DateTimeKind.Local).AddTicks(9757));
            ...
            modelBuilder.Entity("Entities.ItemImage", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 8, 29, 16, 6, 2, 457, DateTimeKind.Local).AddTicks(1692));
