...
namespace Data.Migrations
{
    ...
    [Migration("20231017111349_add_RestartPerhours_in_settings")]
    partial class add_RestartPerhours_in_settings
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Entities.Cart", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        ...
                        .HasDefaultValue(new DateTime(2023, 10, 17, 14, 43, 49, 457, DateTimeKind.Local).AddTicks(4116));
            ...
            modelBuilder.Entity("Entities.Category", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 10, 17, 14, 43, 49, 457, DateTimeKind.Local).AddTicks(5531));
            ...
            modelBuilder.Entity("Entities.Item", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 10, 17, 14, 43, 49, 457, DateTimeKind.Local).AddTicks(7078));
            ...
            modelBuilder.Entity("Entities.ItemImage", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 10, 17, 14, 43, 49, 457, DateTimeKind.Local).AddTicks(7916));
            ...
            modelBuilder.Entity("Entities.User.User", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 10, 17, 14, 43, 49, 457, DateTimeKind.Local).AddTicks(8860));
