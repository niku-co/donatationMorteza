...
namespace Data.Migrations
{
    ...
    [Migration("20221203102647_Remove-MaxLength-LogoPhysicalPath")]
    partial class RemoveMaxLengthLogoPhysicalPath
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Entities.Cart", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        ...
                        .HasDefaultValue(new DateTime(2022, 12, 3, 13, 56, 47, 99, DateTimeKind.Local).AddTicks(8337));
            ...
            modelBuilder.Entity("Entities.Category", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 12, 3, 13, 56, 47, 100, DateTimeKind.Local).AddTicks(1438));
            ...
            modelBuilder.Entity("Entities.Item", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 12, 3, 13, 56, 47, 100, DateTimeKind.Local).AddTicks(4269));
            ...
            modelBuilder.Entity("Entities.ItemImage", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 12, 3, 13, 56, 47, 100, DateTimeKind.Local).AddTicks(6797));
            ...
            modelBuilder.Entity("Entities.SettingTranslation", b =>
                {
                    ...
                    b.Property<string>("LastScreenMessage")
                        .HasMaxLength(300)
