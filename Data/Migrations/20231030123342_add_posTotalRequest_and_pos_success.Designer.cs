...
namespace Data.Migrations
{
    ...
    [Migration("20231030123342_add_posTotalRequest_and_pos_success")]
    partial class add_posTotalRequest_and_pos_success
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Entities.Cart", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        ...
                        .HasDefaultValue(new DateTime(2023, 10, 30, 16, 3, 42, 202, DateTimeKind.Local).AddTicks(5030));
            ...
            modelBuilder.Entity("Entities.Category", b =>
                {
                    ...
                    b.Property<Guid?>("CategoryAgentId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 10, 30, 16, 3, 42, 202, DateTimeKind.Local).AddTicks(6654));
            ...
            modelBuilder.Entity("Entities.CategoryAgent", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
                    ...
                    b.ToTable("CategoryAgents");
                });

            modelBuilder.Entity("Entities.CategoryLog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("Entities.CategoryPingLog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
                    ...
                    b.Property<long>("PosSuccessCounter")
                        .HasColumnType("bigint");

                    b.Property<long>("PosTotalRequestCounter")
                        .HasColumnType("bigint");

                    b.Property<long>("SuccessCounter")
                        .HasColumnType("bigint");

                    b.Property<long>("TotalRequestCounter")
                        .HasColumnType("bigint");

                    b.Property<int>("TurnOnHours")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Entities.DataMNGSetting", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("Entities.Item", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 10, 30, 16, 3, 42, 202, DateTimeKind.Local).AddTicks(8685));
            ...
            modelBuilder.Entity("Entities.ItemImage", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 10, 30, 16, 3, 42, 202, DateTimeKind.Local).AddTicks(9589));
            ...
            modelBuilder.Entity("Entities.PrinterSetting", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("Entities.ProvinceSettting", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
                    ...
                    b.Property<bool>("ApplyProvince")
                        .HasColumnType("bit");

                    b.HasKey("Id");

                    b.ToTable("ProvinceSetttings");
                });

            modelBuilder.Entity("Entities.SMSSetting", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
                    ...
                    b.Property<bool>("AllowSendingSms")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("Entities.Setting", b =>
                {
                    ...
                    b.Property<bool>("RestartIn24Hours")
                        .HasColumnType("bit");

                    b.Property<bool>("RestartPerhours")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("Entities.TagGroup", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Entities.User.User", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 10, 30, 16, 3, 42, 203, DateTimeKind.Local).AddTicks(430));
            ...
            modelBuilder.Entity("Entities.UserProvince", b =>
                {
            ...
            modelBuilder.Entity("Entities.UserTag", b =>
                {
                    b.Property<int>("UserId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Entities.Category", b =>
                {
                    b.HasOne("Entities.CategoryAgent", "CategoryAgent")
                        .WithMany("Categories")
                        .HasForeignKey("CategoryAgentId");

                    b.HasOne("Entities.Province", "Province")
                        .WithMany()
                        .HasForeignKey("ProvinceId");

                    b.Navigation("CategoryAgent");
            ...
            modelBuilder.Entity("Entities.Tag", b =>
                {
                    b.HasOne("Entities.TagGroup", "TagGroup")
                        .WithMany("Tags")
