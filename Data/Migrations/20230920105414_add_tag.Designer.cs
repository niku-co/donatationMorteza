...
namespace Data.Migrations
{
    ...
    [Migration("20230920105414_add_tag")]
            ...
            modelBuilder.Entity("Entities.Cart", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        ...
                        .HasDefaultValue(new DateTime(2023, 9, 20, 14, 24, 14, 647, DateTimeKind.Local).AddTicks(931));
            ...
            modelBuilder.Entity("Entities.Category", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 9, 20, 14, 24, 14, 647, DateTimeKind.Local).AddTicks(2654));
            ...
            modelBuilder.Entity("Entities.Item", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 9, 20, 14, 24, 14, 647, DateTimeKind.Local).AddTicks(5096));
            ...
            modelBuilder.Entity("Entities.ItemImage", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 9, 20, 14, 24, 14, 647, DateTimeKind.Local).AddTicks(6079));
            ...
            modelBuilder.Entity("Entities.User.User", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 9, 20, 14, 24, 14, 647, DateTimeKind.Local).AddTicks(6872));
