...
namespace Data.Migrations
{
    ...
    [Migration("20230905112036_add_branch_toCat")]
    partial class add_branch_toCat
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Entities.Cart", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        ...
                        .HasDefaultValue(new DateTime(2023, 9, 5, 15, 50, 36, 444, DateTimeKind.Local).AddTicks(1049));
            ...
            modelBuilder.Entity("Entities.Category", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 9, 5, 15, 50, 36, 444, DateTimeKind.Local).AddTicks(2422));
            ...
            modelBuilder.Entity("Entities.Item", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 9, 5, 15, 50, 36, 444, DateTimeKind.Local).AddTicks(3756));
            ...
            modelBuilder.Entity("Entities.ItemImage", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 9, 5, 15, 50, 36, 444, DateTimeKind.Local).AddTicks(4585));
            ...
            modelBuilder.Entity("Entities.User.User", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 9, 5, 15, 50, 36, 444, DateTimeKind.Local).AddTicks(5306));
