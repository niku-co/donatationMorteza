...
namespace Data.Migrations
{
    ...
    [Migration("20220804113902_Add-State-Hour-Category")]
    partial class AddStateHourCategory
    {
            ...
            modelBuilder.Entity("Entities.Cart", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        ...
                        .HasDefaultValue(new DateTime(2022, 8, 4, 16, 9, 2, 456, DateTimeKind.Local).AddTicks(1702));
            ...
            modelBuilder.Entity("Entities.Category", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 8, 4, 16, 9, 2, 456, DateTimeKind.Local).AddTicks(4398));
            ...
            modelBuilder.Entity("Entities.Item", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 8, 4, 16, 9, 2, 456, DateTimeKind.Local).AddTicks(6627));
            ...
            modelBuilder.Entity("Entities.ItemImage", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 8, 4, 16, 9, 2, 456, DateTimeKind.Local).AddTicks(8879));
