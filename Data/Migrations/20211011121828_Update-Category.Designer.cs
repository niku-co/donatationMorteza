...
namespace Data.Migrations
{
    ...
    [Migration("20211011121828_Update-Category")]
            ...
            modelBuilder.Entity("Entities.Cart", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        ...
                        .HasDefaultValue(new DateTime(2021, 10, 11, 15, 48, 28, 393, DateTimeKind.Local).AddTicks(1249));
            ...
            modelBuilder.Entity("Entities.Category", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 10, 11, 15, 48, 28, 393, DateTimeKind.Local).AddTicks(5362));
            ...
            modelBuilder.Entity("Entities.Item", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 10, 11, 15, 48, 28, 393, DateTimeKind.Local).AddTicks(7202));
            ...
            modelBuilder.Entity("Entities.ItemImage", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 10, 11, 15, 48, 28, 393, DateTimeKind.Local).AddTicks(9354));
            ...
            modelBuilder.Entity("Entities.CartItem", b =>
                {
                    ...
                    b.HasOne("Entities.Item", "Item")
                        .WithOne("CartItem")
                        .HasForeignKey("Entities.CartItem", "ItemId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
