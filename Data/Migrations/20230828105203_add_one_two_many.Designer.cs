...
namespace Data.Migrations
{
    ...
    [Migration("20230828105203_add_one_two_many")]
    partial class add_one_two_many
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Entities.Cart", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        ...
                        .HasDefaultValue(new DateTime(2023, 8, 28, 15, 22, 3, 92, DateTimeKind.Local).AddTicks(7398));
            ...
            modelBuilder.Entity("Entities.Category", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 8, 28, 15, 22, 3, 92, DateTimeKind.Local).AddTicks(8763));
            ...
            modelBuilder.Entity("Entities.Item", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 8, 28, 15, 22, 3, 93, DateTimeKind.Local).AddTicks(221));
            ...
            modelBuilder.Entity("Entities.ItemImage", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 8, 28, 15, 22, 3, 93, DateTimeKind.Local).AddTicks(1047));
            ...
            modelBuilder.Entity("Entities.User.User", b =>
                {
                    ...
                    b.Property<DateTime>("InsertTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 8, 28, 15, 22, 3, 93, DateTimeKind.Local).AddTicks(1690));
