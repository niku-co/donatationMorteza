    ...
    public static class SwaggerConfigurationExtensions
    {
        public static void AddSwagger(this IServiceCollection services)
        {
            ...
            services.AddSwaggerGen(options =>
            {
                ...
                var xmlDocPath = Path.Combine(AppContext.BaseDirectory, "MahakApi.xml");
                ...
                options.ResolveConflictingActions(apiDescriptions => apiDescriptions.First()); //This line resolves the conflicts
                #region Filters
                ...
                options.OperationFilter<UnauthorizedResponsesOperationFilter>(true);
